...
export class ResenaController {
    getAllByProfesional = async (request, response, next) => {
        try {
    ...
    getDetailById = async (request, response, next) => {
        try {
            const { id } = request.params;
    ...
    promedioCalificacionPorProfesional = async (request, response, next) => {
        try {
            const { idProfesional } = request.params;
            const resultado = await ResenaService.promedioCalificacionPorProfesional(Number(idProfesional));
    ...
    obtenerPorCita = async (request, response, next) => {
        try {
