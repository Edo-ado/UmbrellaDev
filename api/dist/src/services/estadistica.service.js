...
export const EstadisticaService = {
    async getCitasPorEstado(fechaInicio, fechaFin, idprofesional, idcategoria) {
    ...
    async getReportePorProfesional(idprofesionalFiltro) {
        let citas;
    ...
    async getReporteCalificaciones(idprofesionalFiltro) {
        ...
        for (const profesional of profesionales) {
            ...
            const resenasDelProfesional = resenas.filter((r) => r.profesionalId === profesional.Id);
