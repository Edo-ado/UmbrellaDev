...
export class EstadisticaRoutes {
    static get routes() {
        ...
        router.get("/reporte-profesional", authenticateToken, estadisticaController.getReportePorProfesional);
        router.get("/reporte-calificaciones", authenticateToken, estadisticaController.getReporteCalificaciones);
        return router;
    }
}
